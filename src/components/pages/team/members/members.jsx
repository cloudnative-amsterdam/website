...
const ITEMS = [
  {
    ...
    position: 'Technical Lead - Microsoft',
    photo: AlessandroPhoto,
    url: 'https://www.linkedin.com/in/alessandrovozza/', // Updated URL
  },
  {
    name: 'Luca Berton',
...
const LOGOS = [
  { icon: lovelace, url: 'http://lovelace.engineering', iconClassName: 'w-[250px] h-auto' },
  { icon: lovelace, url: 'https://whiteduck.de/', iconClassName: 'w-[250px] h-auto' },
];
