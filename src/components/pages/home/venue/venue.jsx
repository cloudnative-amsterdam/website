        ...
        <div className="flex flex-col gap-6">
          ...
          <Card>
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-[#004258]">DOOR Open Space</h2>
                <h3 className="text-xl text-gray-600">at NDSM, Amsterdam</h3>
              </div>
              ...
              <div className="mb-4 flex gap-2 text-gray-600">
                ...
                <div>
                  <p>Tt. Vasumweg 31</p>
                  <p>1033 SK Amsterdam</p>
                </div>
              </div>

              <a
                href="https://maps.google.com/?q=DOOR+Open+Space+Tt.+Vasumweg+31+1033+SK+Amsterdam"
                target="_blank"
