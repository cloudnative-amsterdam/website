            ...
            <div className="space-y-4">
              <div className="flex justify-between text-sm">
                ...
                <div className="text-right">
                  ...
                  <div className="font-medium">29 January 2026 11:59 PM</div>
                </div>
              </div>
        ...
        <div className="rounded-lg border bg-white shadow-sm">
          ...
          <div className="space-y-4 p-6">
            ...
            <p className="text-gray-600">
              The Cloud Native Community Days are an excellent way to get to know the community and share your ideas.
            </p>
            ...
            >
              <button
                className="button"
                onClick={() =>
                  window.open('https://talks.cloudnative.amsterdam/cloud-native-community-days-2026/cfp', '_blank')
                }
              >
                Submit a session
              </button>
