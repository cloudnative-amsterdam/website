  ...
  <section className="info-section">
    <div className="info-container">
      ...
      <div className="about-section">
        <h2 className="section-title">About Cloud Native Community Days Amsterdam</h2>

        <div className="about-content">
          <div className="about-text">
            <p>
              Cloud Native Community Days (CNCD) Amsterdam is a local, community-organized event that gathers
          ...
          <div className="about-text">
            <p>
              This is the fourth edition in The Netherlands, aiming to bring the community together. The
          ...
          <div className="feature-item">
            ...
            <div className="feature-content">
              ...
              <p className="feature-text">
                An exceptional open space artistic venue with ample space for activities
              </p>
            </div>
          </div>
        </div>
