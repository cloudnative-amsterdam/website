...
We thrive on the community and want to give back to it. We are committed to making this event a success for everyone involved, and we believe that by focusing on the community, we can create a more meaningful and impactful experience for all attendees. We want to create a space where people can come together, share their experiences, and learn from each other. We believe that this is essential for the growth and success of the cloud-native community as a whole.
